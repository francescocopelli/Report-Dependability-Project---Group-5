...
\item  \textbf{android.permission.VIBRATE }$\rightarrow$ Controls the vibration engine.
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\linewidth]{img/manifest_first.png}
    ...
    \end{figure}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=1\linewidth]{img/first_relations.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{img/mobsf_one_scorecard.png}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.48\linewidth}
        \centering
        \includegraphics[width=0.68\linewidth]{img/screenshots/screenshot-2026-06-26_16.36.35.339.png}
    ...
    \begin{subfigure}[t]{0.48\linewidth}
        \centering
        \includegraphics[width=0.68\linewidth]{img/screenshots/screenshot-2026-06-26_16.34.31.953.png}
    ...
    \begin{subfigure}[t]{0.48\linewidth}
        \centering
        \includegraphics[width=0.68\linewidth]{img/screenshots/screenshot-2026-06-26_16.34.18.192.png}
    ...
    \begin{subfigure}[t]{0.48\linewidth}
        \centering
        \includegraphics[width=0.68\linewidth]{img/screenshots/screenshot-2026-06-26_16.33.06.863.png}
