...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=\textwidth]{virustotal_2_summary.png}
...
\begin{figure}[h]
        ...
        \includegraphics[width=0.8\linewidth]{virustotal_2_detection_complete.png}
        \caption{VirusTotal Detection for \twor}
        \label{fig:virustotal_2_detections}
        \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\linewidth}
            \includegraphics[width=0.8\linewidth]{virustotal_second_permissions.png}
        \end{subfigure}
\end{figure}
...
\begin{figure}[h]
        \centering
        \includegraphics[width=\textwidth]{second_relations.png}
...
\begin{figure}[h]
        \centering
        \includegraphics[width=\textwidth]{manifest_second.png}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.48\linewidth}
        ...
        \caption{App info screen for Gwangju Bus v3.3.7 showing outdated database state \twor}
